...
from yolov3_tf2.utils import draw_outputs_ori, location_convert, image_preprocess, location_convert_rgb, check_list_1, check_list_2, location2motor
import numpy as np
import serial
...
flags.DEFINE_string('output', './video/detect_video/classification_3_60.avi', 'path to output video')
